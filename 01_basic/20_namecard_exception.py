...
# with open(path+'/cardbook1.pickle','rb')as f: ##01_basic을 없애고 path+붙임
...
>>>''')
    if menu == '1':
        ...
        try:
            ...
            print('인덱스 오류')
        except Exception as e: #except는 여러개가 올 수 있다. 
            #모든 예외를 갖고 있기 때문에 다른 거랑 같이 쓸때 맨 뒤로 보내야한다.exception이 부모
            print(e)
